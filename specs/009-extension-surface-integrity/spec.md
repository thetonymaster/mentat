...
**Why this priority**: Documentation debt, not a live defect — but it is the stated precondition for the next features (010–013), and today the "six seams" are defined differently in two places while one comparator's internal-only status is documented nowhere.
