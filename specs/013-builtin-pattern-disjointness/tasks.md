...
- [ ] T024 [US2] Flesh out `internal/steps/disjoint.go` from T004's stub: `Intersection` gains `Intersects bool` / `Witness string` per contracts/decider.md, and `Intersects` stops returning the not-implemented error
