...
func TestClauseToExpectation(t *testing.T) {
	...
	tests := []struct {
		...
		{"fanout whitespace count", clauseYAML{Fanout: fan("a=b", "c=d", "   ")}, "", true},
		{"fanout with top-level of", clauseYAML{Fanout: fan("a=b", "c=d", ">=1"), Of: "e=f"}, "", true},
		{"fanout with top-level count", clauseYAML{Fanout: fan("a=b", "c=d", ">=1"), Count: ">=1"}, "", true},
